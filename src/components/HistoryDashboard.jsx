...
import { History, FileText, Calendar, Eye, Download, Search, RefreshCw, Layers } from 'lucide-react';
    ...
    <div style={{ animation: 'fadeIn 0.5s ease', maxWidth: '1100px', margin: '0 auto' }}>
      <div className="glass-panel" style={{ padding: '1.5rem 2rem', marginBottom: '2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            ...
            <p style={{ margin: '0.4rem 0 0 0', color: 'var(--text-muted)', fontSize: '0.9rem' }}>
              All previously analyzed software documents stored permanently in your MongoDB database.
            </p>
          </div>
          <button 
        ...
        <div style={{ marginTop: '1.5rem', position: 'relative' }}>
          ...
          <input 
            type="text" 
            placeholder="Search saved software records by name or summary..."
            value={searchTerm}
              ...
              <div key={idx} className="glass-panel" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
                    ...
                    <div style={{ fontWeight: '600', fontSize: '1.05rem', color: '#f8fafc', wordBreak: 'break-word' }}>
